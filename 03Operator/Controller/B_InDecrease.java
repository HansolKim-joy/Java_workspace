...
public class B_InDecrease {
	...
	// 값++, 값-- : 후위 연산자 => 다른 연산자 부터 계산 후 나 계산
	...
	public void method3() {
		int num1 = 20;
		int result = num1++ * 3;
		System.out.println("result : " + result); //60 - 후위 연산자 : 남부터
		System.out.println("num1 : " + num1); //21
		
		int num2 = 20;
		int result2 = ++num2 * 3;
		System.out.println("result2 : " + result2); //63 - 전위 연산자 : 나부터
	...
	public void method4() {
		...
		System.out.println((++a) + (b++)); // 32 => 12 / 21
		
		System.out.println((a++) + (--b) + (--c)); // 61 => 13 / 20 / 29
